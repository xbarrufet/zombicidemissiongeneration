...
public class Vehicle extends Token {

    public Vehicle(String subtype, Image image, int width, int height) {
        super(TokenType.VEHICLES, TokenShape.createSquare(width, height), TokenOrientation.Horizontal, subtype, image);
    }
