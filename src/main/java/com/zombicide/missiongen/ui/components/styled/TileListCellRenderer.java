...
/**
 * Custom list cell renderer for tile list with thumbnail and metadata.
 */
public class TileListCellRenderer extends JPanel implements ListCellRenderer<String> {
    
    private JLabel nameLabel;
    private JLabel thumbnailLabel;
    private boolean isSelected;
    
    public TileListCellRenderer() {
    ...
    public Component getListCellRendererComponent(JList<? extends String> list, String value,
        ...
        setPreferredSize(new Dimension(list.getWidth() - 10, 40));
    ...
    /**
     * Sets a thumbnail image for the tile.
     * 
