...
public class ZoneMissionGridProperties extends ZonePropertiesPanel
        implements com.zombicide.missiongen.ui.interfaces.TileGridListener,
        com.zombicide.missiongen.ui.interfaces.PanelSelectionListener {
    ...
    private final java.util.List<com.zombicide.missiongen.ui.interfaces.PanelSelectionListener> tileSelectionListeners = new java.util.ArrayList<>();
    ...
    public void addTileSelectionListener(com.zombicide.missiongen.ui.interfaces.PanelSelectionListener listener) {
        tileSelectionListeners.add(listener);
    }

    private void fireTileSelected(com.zombicide.missiongen.model.Tile tile) {
        for (com.zombicide.missiongen.ui.interfaces.PanelSelectionListener listener : tileSelectionListeners) {
