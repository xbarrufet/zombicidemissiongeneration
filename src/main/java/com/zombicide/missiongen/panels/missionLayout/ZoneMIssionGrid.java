...
public class ZoneMissionGrid extends ZoneDrawPanel
        implements com.zombicide.missiongen.panels.interfaces.GridClickListener {
    ...
    private final java.util.List<com.zombicide.missiongen.panels.interfaces.TileGridListener> tileGridListeners = new java.util.ArrayList<>();
    ...
    public void addTileGridListener(com.zombicide.missiongen.panels.interfaces.TileGridListener listener) {
        tileGridListeners.add(listener);
    }

    private void fireTilePlaced(int row, int col, TileBoard tileBoard) {
        for (com.zombicide.missiongen.panels.interfaces.TileGridListener listener : tileGridListeners) {
