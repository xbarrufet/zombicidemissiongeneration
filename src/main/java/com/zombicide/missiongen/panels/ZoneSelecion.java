...
public class ZoneSelecion extends JPanel {
    private static final Logger logger = LoggerFactory.getLogger(ZoneSelecion.class);
    ...
    private final java.util.List<TileSelectionListener> tileSelectionListeners;
    ...
    private void onTileSelected() {
        ...
        if (tileName != null && !tileName.equals("(No tiles found)")) {
            ...
            saveTileButton.setEnabled(tile != null);
